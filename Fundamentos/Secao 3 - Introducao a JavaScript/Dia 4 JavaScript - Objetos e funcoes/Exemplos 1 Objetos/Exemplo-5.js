...
// ou player.bestInTheWorld = [2006, 2007, 2008, 2009, 2010, 2018];
...
console.log(`A jogadora possui ${player['name']} ${player['lastName']} possui ${player['medals']['golden']} medalhas de ouro e ${player['medals']['silver']} medalhas de prata`);
