...
const getTotalPopulation = countries.reduce((acc, curr) => acc + curr.population, 0)
...
const countryWithLongestName = countries.reduce((acc, curr) => acc.name.length > curr.name.length ? acc : curr)
