...
describe('4 - Exiba a lista de produtos cadastrados ao clicar no botão "Ver produtos"', () => {
  ...
  it.skip('Será validado que ao clicar no botão "Ver produtos" a lista de produtos é renderizada', () => {
  ...
  it.skip('Será validado que ao clicar no botão "X" de um produto, o produto é removido da lista', () => {
