...
describe('1 - Faça com que o próximo livro da lista seja exibido ao clicar no botão `Próximo livro`', () => {
  ...
  it.only('Ao clicar no botão `Próximo livro`, as informações dos próximos livros da lista estão sendo exibidas', async () => {
  ...
  it.skip('Ao chegar no último livro da lista, ao clicar no botão `Próximo livro`, as informações do primeiro livro da lista estão sendo exibidas', async () => {
...
describe('2 - Gerencie o estado para cada uma das listas e exiba por padrão a lista de desejos', () => {
  ...
  it.skip('Ao clicar no botão `Adicionar à lista de desejos`, o livro é adicionado à lista de desejos e as informações do livro são exibidas na tela', async () => {
    const firstBook = booksList[0];
...
describe('3 - Faça com que seja possível mudar a lista exibida ao clicar em um dos botões de exibição', () => {
  ...
  it.skip('Ao clicar no botão `Exibir lista de desejos`, a lista de desejos é exibida', async () => {
    const firstBook = booksList[0];
  ...
  it.skip('Ao clicar no botão `Exibir lista de leitura`, a lista de leitura é exibida', async () => {
    const secondBook = booksList[1];
  ...
  it.skip('Ao clicar no botão `Exibir lista de lidos`, a lista de lidos é exibida', async () => {
